import { Grid3x3, FileText, DollarSign, FileCheck, AlertCircle } from "lucide-react";

const categories = [
  { id: "all", label: "All", icon: Grid3x3 },
  { id: "annual", label: "Annual", icon: FileText },
  { id: "financial", label: "Financial", icon: DollarSign },
  { id: "factsheet", label: "Fact Sheet", icon: FileCheck },
  { id: "sitrep", label: "Situation Report", icon: AlertCircle },
];
