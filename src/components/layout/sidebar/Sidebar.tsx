...
export function Sidebar({ activeMenu, setActiveMenu, isCollapsed, setIsCollapsed, isMobileMenuOpen, setIsMobileMenuOpen }: SidebarProps) {
  ...
  const otherMenuItems = [
    ...
    { id: "rights-holders", label: "Rights Holders", icon: Users },
  ];
  ...
  const SidebarContent = ({ isMobile = false }: { isMobile?: boolean }) => (
    <div className="h-full bg-white/95 backdrop-blur-2xl rounded-none lg:rounded-3xl shadow-2xl shadow-[#268ece]/10 border-0 lg:border border-[#268ece]/10 flex flex-col relative overflow-hidden">
  ...
  return (
    <>
      ...
      <div className="hidden lg:block relative">
        <div className={`fixed left-12 top-24 bottom-12 z-40 transition-all duration-500 ${isCollapsed ? "w-20" : "w-80"}`}>
